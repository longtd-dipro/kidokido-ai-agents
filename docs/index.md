...
- **[Màn hình thực tế — Admin](screens/admin.md)** — screenshot + sơ đồ điều hướng chụp trực tiếp từ UI admin thật, giúp hình dung màn hình tương ứng với từng tính năng. Chỉ xem local, không commit lên git (dữ liệu môi trường test).
